...
public class WeatherReturn extends ReturnType{
    ...
    public String toString(){
    	String r = "";
    	r+= success+System.lineSeparator();
    	r+= responseText+System.lineSeparator();
        r+=state+System.lineSeparator();
        r+=city+System.lineSeparator();
        r+=weatherStationCity+System.lineSeparator();
        r+=weatherID+System.lineSeparator();
        r+=description+System.lineSeparator();
        r+=temperature+System.lineSeparator();
        r+=relativeHumidity+System.lineSeparator();
        r+=wind+System.lineSeparator();
        r+=pressure+System.lineSeparator();
        r+=visibility+System.lineSeparator();
        r+=windChill+System.lineSeparator();
        r+=remarks+System.lineSeparator();
    	return r;
    }

	@Override
	public HashMap<String, Object> getReturnedData() {
		HashMap<String, Object> hash = new HashMap<String, Object>();
		hash.put("Success", success);
		hash.put("ResponseText", responseText);
		hash.put("State", state);
		hash.put("City", city);
		hash.put("WeatherStationCity", weatherStationCity);
		hash.put("WeatherID", weatherID);
		hash.put("Description", description);
		hash.put("Temperature", temperature);
		hash.put("RelativeHumidity", relativeHumidity);
		hash.put("Wind", wind);
		hash.put("Pressure", pressure);
		hash.put("Visibility", visibility);
		hash.put("WindChill", windChill);
		hash.put("Remarks", remarks);
		return hash;
	}
}
